...
<head>
    <script type="text/javascript" src="${resource(file:'jquery-1.7.1.min.js')}"></script>
    <script type="text/javascript" src="${resource(file:'jquery-ui-1.10.4.min.js')}"></script>
    <link rel="stylesheet" href="${resource(file:'jquery-ui.css')}">
    <link rel="stylesheet" href="${resource(file:'ruleEditor.css')}">
    <link rel="stylesheet" href="${resource(file:'ng-modal.css')}">
    ...
    <script src="/static/angular/lib/angular.min.js"></script>
    <script src="/static/angular/lib/angular-sanitize.min.js"></script>
    <script src="/static/angular/lib/angular-animate.min.js"></script>
    <script src="/static/angular/app.js"></script>
    <script src="/static/angular/services.js"></script>
    <script src="/static/angular/posTagHelperServices.js"></script>
    <script src="/static/angular/xmlBuildServices.js"></script>
    <script src="/static/angular/xmlParseServices.js"></script>
    <script src="/static/angular/directives.js"></script>
    <script src="/static/angular/modules/sortable.js"></script>
    <script src="/static/angular/modules/ng-modal.min.js"></script>
</head>
...
<div class="body ruleEditor">
  ...
  <g:link controller="ruleEditor" action="expert">Expert Mode</g:link></p>
  ...
  <form>
      ...
      <div ng-show="gui.patternEvaluated" ng-cloak>
          ...
          <div id="ruleAsXml" ng-cloak ng-bind-html="buildEscapedXml(true)"></div>
